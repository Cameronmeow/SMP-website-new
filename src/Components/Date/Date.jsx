  ...
  return (
    <div className="annoucements">
      <div className="annoucementContainer">
            <div className="col-md-12 annoucementTitle" >
            ...
            <div className="col-md-12">
              <div className="section-content">
                <table className="table table-condensed section-table" >
                  <tbody>
                    <tr className="annoucementItem">
                      <td className="annoucementEvent" style={{backgroundColor:"transparent", border:"none"}}>
                        Results of JEE Advanced (2023)
                      </td>
                      <td className="annoucementDates" style={{backgroundColor:"transparent" , border:"none"}}>18th June 2023</td>
                    </tr>
                    <tr className="annoucementItem">
                      <td className="annoucementEvent" style={{backgroundColor:"transparent" , border:"none"}}>
                        Tentative Start of Seat Allotment
                      </td>
                      <td className="annoucementDates" style={{backgroundColor:"transparent" , border:"none"}}>
                        Oct 27 - Nov 20, 2021
                      </td>
                    </tr>
                    <tr className="annoucementItem">
                      ...
                      <td className="annoucementDates" style={{backgroundColor:"transparent" , border:"none"}}>19th June 2023</td>
                    </tr>
                    <tr className="annoucementItem">
                      <td className="annoucementEvent" style={{backgroundColor:"transparent" , border:"none"}}>
                    ...
                    <tr className="annoucementItem">
                      ...
                      <td className="annoucementDates" style={{backgroundColor:"transparent" , border:"none"}}>31st July 2023</td>
                    </tr>
                    <tr className="annoucementItem">
                      <td className="annoucementEvent" style={{backgroundColor:"transparent" , border:"none"}} >
                    ...
                    <tr className="annoucementItem">
                      ...
                      <td className="annoucementDates" style={{backgroundColor:"transparent" , border:"none"}} >7th August 2023</td>
                    </tr>
                  </tbody>
                </table>
